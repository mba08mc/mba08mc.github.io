...
var rssFetchAndDisplay = {
	aFeeds: [[['hot-news'],['The latest Hot News headlines from Altnet'],['<a href="/hotnews/">Hot News Headlines<\/a>'],['http://altnet.online/home/2007/ticker.rss']]],
	iCurrentFeedsItem: 0,
	aNews: new Array(),
	iCurrentNewsItem: 0,
	tTM: null,
	...
	Create: function(req)
		...
		oTickerCont.innerHTML = "\n\r"+'<table border="0" cellpadding="0" cellspacing="0" class="'+r.sState+'">'+"\n\r"+'<tr><td id="tic-title"><span>'+r.aFeeds[r.iCurrentFeedsItem][2]+'</span></td><td id="tic-item"><a href="/hotnews/">'+r.aNews[r.iCurrentNewsItem].title+'</a></td></tr>'+"\n\r"+'</table>'+"\n\r";
	...
	ParseXMLToArray: function(req)
		...
		for (var i=0;i<aItems.length;i++)
			...
			r.aNews[i].url = '/hotnews/'; //aItems[i].getElementsByTagName('link')[0].firstChild.nodeValue;
			}
		},
